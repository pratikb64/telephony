...
const { defaultCallingMedium, exotelEnabled, setMakeCall, twilioEnabled } = telephonyStore();
...
function makeCall(number) {
	console.log(twilioEnabled.value, exotelEnabled.value, defaultCallingMedium.value);
	console.log(twilioEnabled.value && exotelEnabled.value && !defaultCallingMedium.value);
	if (twilioEnabled.value && exotelEnabled.value && !defaultCallingMedium.value) {
...
async function setDefaultCallingMedium() {
	...
	toast.success(`Default calling medium set successfully to ${callMedium.value}`);
}
